...
// MongoDB Connections
mongoose.connect('mongodb://192.168.13.208:27017/messageLog', {
  useNewUrlParser: true,
  useUnifiedTopology: true
});

const renderJobConnection = mongoose.createConnection('mongodb://192.168.13.208:27017/renderJobManager', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});

// Use a separate connection for Image model
const imageConnection = mongoose.createConnection('mongodb://192.168.13.208:27017/uploadedImageObj', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
